    ...
    <section className="py-16 bg-white overflow-hidden">
      ...
      <SectionContainer maxWidth="2xl" className="px-8 md:px-12 lg:px-16">
        ...
        <div className="text-center mb-12 px-4">
          <span className="text-[#86935b] text-[10.5px] font-medium mb-4 block tracking-wider">Specs</span>
        ...
        {/* Grid Layout Section */}
          ...
          <div className="lg:grid lg:grid-cols-12 lg:items-stretch flex flex-row gap-4 lg:gap-0 overflow-x-auto lg:overflow-visible">
          
          {/* EMPTY SPACE LEFT - hidden on mobile */}
          <div className="hidden lg:block lg:col-span-1"></div>
          
          {/* COLUMN 1: MAIN AREA CARD */}
          <div className="lg:col-span-3 bg-white border border-gray-200 rounded-[2.5rem] relative z-10 shadow-sm flex-shrink-0 w-80 lg:w-auto">
            ...
            {columns[0].items.map((item, i) => (
              ...
              >
                ...
                <span
                  className="text-[10.5px] tracking-tighter text-[#000000] font-normal leading-none"
          ...
          {/* COLUMN 2 & 3: COMPARISON GRID */}
          <div className="lg:col-span-7 flex-shrink-0 lg:flex-shrink">
            <div className="grid grid-cols-2 relative min-w-max lg:min-w-0">
              <div className="h-28 flex items-center justify-center">
                <h3 
          ...
          {/* EMPTY SPACE RIGHT - hidden on mobile */}
          <div className="hidden lg:block lg:col-span-1"></div>
        </div>
      </div>
        </SectionContainer>
